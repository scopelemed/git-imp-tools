...
function New-HtmlReport {
    ...
    $rows = $Items | ForEach-Object {
        ...
        "<tr><td>$repo</td><td>$branch</td><td>$author</td><td>$email</td><td>$committer</td><td>$date</td><td>$sha</td><td>$msg</td></tr>"
    }
...
$ordered = $results | Sort-Object CommitDate, Repository, Branch -Descending
